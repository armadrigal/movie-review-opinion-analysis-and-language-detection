...
@router.post("/OpinionAnalysis/es/lstmattention", summary="Opinion Analysis, Language: Spanish, Model: LSTM+Attention")
async def opinion_es_lstm_attention(data: List[InputData]):
    ...
    y_pred = np.round(main.model_lstm_attention_es(texts), 2)
